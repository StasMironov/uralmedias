...
!function (t) {
  ...
  var o = function () {
    ...
    return e = t, (n = [{
      ...
      value: function value(t) {
        ...
        switch (t) {
          case "space":
            this.slider.params.spaceBetween = e, this.slider.update();
            break;

          case "view":
            this.slider.params.slidesPerView = e, this.slider.update();
            break;

          case "center":
            this.slider.params.centeredSlides = e, this.slider.update();
            break;

          case "initialSlide":
            this.slider.params.initialSlide = e, this.slider.update();
            break;

          case "slideActiveClass":
            this.slider.params.slideActiveClass = e, this.slider.update();
            break;
          ...
          case "slideToClickedSlide":
            this.slider.params.slideToClickedSlide = e, this.slider.update();
            break;

          case "controller":
            this.slider.params.controller = e, this.slider.update(), console.log(this.slider.params.controller);
            break;
          ...
          case "group":
            this.slider.params.slidesPerGroup = e, this.slider.params.speed = 1e3, this.slider.update();
            break;
  ...
  t.exports = function (t, e, n) {
    ...
    if (i(t, "function" != typeof g || !(m || b.forEach && !f(function () {
      new g().entries().next();
    })))) x = n.getConstructor(e, t, v, y), s.REQUIRED = !0;else if (i(t, !0)) {
      var S = new x(),
          E = S[y](m ? {} : -0, 1) != S,
          T = f(function () {
        S.has(1);
      ...
      })).prototype = b, b.constructor = x), (T || A) && (_("delete"), _("has"), v && _("get")), (A || E) && _(y), m && b.clear && delete b.clear;
    }
    return w[t] = x, r({
      global: !0,
      forced: x != g
  ...
  t.exports = function (t, e, n, l, d, g, b) {
    ...
    if (j && (x = i(j.call(new t())), h !== Object.prototype && x.next && (f || i(x) === h || (a ? a(x, h) : "function" != typeof x[m] && c(x, m, y)), s(x, E, !0, !0), f && (p[E] = y))), "values" == d && A && "values" !== A.name && (T = !0, P = function P() {
      return A.call(this);
    }), f && !b || O[m] === P || c(O, m, P), p[e] = P, d) if (w = {
      values: S("values"),
      keys: g ? P : S("keys"),
      entries: S("entries")
    }, b) for (_ in w) {
  ...
  var r = n(22),
    ...
    return function (h, v, m, y) {
      for (var g, b, x = i(h), w = o(x), _ = r(v, m, 3), S = a(w.length), E = 0, T = y || s, O = e ? T(h, S) : n || p ? T(h, 0) : void 0; S > E; E++) {
        if ((d || E in w) && (b = _(g = w[E], E, x), t)) if (e) O[E] = b;else if (b) switch (t) {
          case 3:
            return !0;
  ...
  t.exports = function (t) {
    var e,
        ...
        b = u(h),
        x = 0;
    if (g && (y = r(y, m > 2 ? arguments[2] : void 0, 2)), null == b || v == Array && a(b)) for (n = new v(e = s(h.length)); e > x; x++) {
      d = g ? y(h[x], x) : h[x], c(n, x, d);
    } else for (p = (f = b.call(h)).next, n = new v(); !(l = p.call(f)).done; x++) {
      d = g ? i(f, y, [l.value, x], !0) : l.value, c(n, x, d);
    }
    return n.length = x, n;
  };
}, function (t, e, n) {
  ...
  ***************************************************************************** */
  ...
  function X(t) {
    var e = V.get(t) || [];
    return V.set(t, e), function (t, n, r) {
      function o(t) {
  ...
  var _t = new Map(),
    ...
    return Object.defineProperty(t.prototype, "parent", {
      ...
      var t,
          ...
          n = this.containerEl,
          r = this.contentEl;
      t = this, (e = V.get(t)) && (e.forEach(function (t) {
        var e = t.elem,
            n = t.eventName,
            r = t.handler;
        e.removeEventListener(n, r, G());
      }), V["delete"](t)), this._listeners.clear(), this.setMomentum(0, 0), cancelAnimationFrame(this._renderID), this._observer && this._observer.disconnect(), _t["delete"](this.containerEl);
  ...
  function Bt() {
    ...
    gsap.set(o, {
      ...
      autoAlpha: 1
    }), e = document.querySelector(".footer").offsetHeight, r = document.documentElement.clientHeight, n = r - (r - e), $(".b-page").css("padding-bottom", n), Qt(), function (t) {
      var e;
      ...
      if ($(".js-pin").exists()) try {
        ...
        }), zt(t, "pinReparent", !0), zt(t, "pinSpacing", !1), t));
      } catch (t) {
        console.log(t);
      }
