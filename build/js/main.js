...
!function (t) {
  ...
  t.exports = function (t, e, n) {
    ...
    if (i(t, "function" != typeof g || !(m || x.forEach && !f(function () {
      new g().entries().next();
    })))) b = n.getConstructor(e, t, v, y), s.REQUIRED = !0;else if (i(t, !0)) {
      var S = new b(),
          E = S[y](m ? {} : -0, 1) != S,
          T = f(function () {
        S.has(1);
      ...
      })).prototype = x, x.constructor = b), (T || A) && (_("delete"), _("has"), v && _("get")), (A || E) && _(y), m && x.clear && delete x.clear;
    }
    return w[t] = b, r({
      global: !0,
      forced: b != g
    }, w), d(b, t), m || n.setStrong(b, t, v), b;
  };
}, function (t, e, n) {
  var r = n(4),
      o = n(16),
  ...
  t.exports = function (t, e, n) {
    var l,
      ...
      return l && c(l), new u(!0, t);
        ...
        S = function S(t) {
      return g ? (r(t), b ? w(t[0], t[1], _) : w(t[0], t[1])) : b ? w(t, _) : w(t);
    };
  ...
  t.exports = function (t, e, n, l, d, g, x) {
    o(n, e, l);
    ...
    if (P && (b = i(P.call(new t())), h !== Object.prototype && b.next && (f || i(b) === h || (a ? a(b, h) : "function" != typeof b[m] && c(b, m, y)), s(b, E, !0, !0), f && (p[E] = y))), "values" == d && A && "values" !== A.name && (T = !0, j = function j() {
      return A.call(this);
    }), f && !x || O[m] === j || c(O, m, j), p[e] = j, d) if (w = {
      values: S("values"),
      keys: g ? j : S("keys"),
      entries: S("entries")
    }, x) for (_ in w) {
      (v || T || !(_ in O)) && u(O, _, w[_]);
    } else r({
      target: e,
      proto: !0,
      forced: v || T
  ...
  var r = n(21),
    ...
    return function (h, v, m, y) {
      for (var g, x, b = i(h), w = o(b), _ = r(v, m, 3), S = a(w.length), E = 0, T = y || s, O = e ? T(h, S) : n || p ? T(h, 0) : void 0; S > E; E++) {
        if ((d || E in w) && (x = _(g = w[E], E, b), t)) if (e) O[E] = x;else if (x) switch (t) {
          case 3:
            return !0;
  ...
  t.exports = function (t) {
    var e,
        ...
        x = u(h),
        b = 0;
    if (g && (y = r(y, m > 2 ? arguments[2] : void 0, 2)), null == x || v == Array && a(x)) for (n = new v(e = s(h.length)); e > b; b++) {
      d = g ? y(h[b], b) : h[b], c(n, b, d);
    } else for (p = (f = x.call(h)).next, n = new v(); !(l = p.call(f)).done; b++) {
      d = g ? i(f, y, [l.value, b], !0) : l.value, c(n, b, d);
    }
    return n.length = b, n;
  };
}, function (t, e, n) {
  ...
  ***************************************************************************** */
  ...
  var O = function O(t) {
    return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : T && T in Object(t) ? _(t) : E(t);
  };
  ...
  var H = function H(t, e, n) {
    ...
    return e = C(e) || 0, d(n) && (l = !!n.leading, i = (f = "maxWait" in n) ? q(C(n.maxWait) || 0, e) : i, p = "trailing" in n ? !!n.trailing : p), x.cancel = function () {
  ...
  var nt = function () {
    ...
    }, a([B(300)], t.prototype, "autoHideOnIdle", null), t;
  }();
  ...
  function vt(t) {
    X(t)(window, "resize", H(t.update.bind(t), 300));
  }
    ...
    return Object.defineProperty(t.prototype, "parent", {
      ...
      void 0 === e && (e = {}), function (t, e, n) {
        ...
        if (e && h.contains(e)) {
          ...
          if (!s || !t.isVisible(e)) {
            var x = i ? g.top - v.top - u : g.bottom - v.bottom + d;
            t.setMomentum(g.left - v.left - f, z(x, -m.y, y.y - m.y));
          }
        }
      }(this, t, e);
  ...
  if ($(".blog__item").exists() && (gsap.to(".blog__item", {
    ...
    It.on("scroll", function () {
      (window.pageYOffset || document.documentElement.scrollTop) > qt ? Rt.addClass("mf-fixed") : Rt.removeClass("mf-fixed");
    });
  } catch (t) {
    console.log(t);
  }
  ["/portfolio"].filter(function (t) {
    console.log(window.location.pathname.indexOf(t)), 0 === window.location.pathname.indexOf(t) ? $(".header").addClass("mf-transparent") : $(".header").removeClass("mf-transparent");
  }), ["/", "/index.html"].filter(function (t) {
  ...
  function Nt() {
    ...
    gsap.set(s, {
      ...
      var e = Ot.init(document.querySelector("#viewport"), {
        damping: .04,
        delegateTo: document
      });
      if ($(".js-form-call").exists() && $(".js-form-call").on("click", function (t) {
        ...
        var n = document.querySelector(".header"),
            r = n.querySelector(".burger"),
            o = n.querySelector(".js-nav"),
            i = new TimelineMax({
          reversed: !0,
          paused: !0,
          defaults: {
        ...
        i.to(o, {
          ...
          this.classList.toggle("opened"), this.setAttribute("aria-expanded", this.classList.contains("opened")), this.classList.contains("opened") ? (i.reverse(), a.play(), e.updatePluginOptions("modal", {
            open: !0
      ...
      t && e.setPosition(0, 0), $("a").click(function () {
        if (location.pathname.replace(/^\//, "") == this.pathname.replace(/^\//, "") && location.hostname == this.hostname) {
          var t = $(this.hash);
          if ((t = t.length && t || $("[name=" + this.hash.slice(1) + "]")).length) return t.offset().top, e.scrollIntoView(document.querySelector("#request"), {
            offsetBottom: 100,
            alignToTop: !1,
            onlyScrollIfNeeded: !0
          }), !1;
        }
      }), e.track.xAxis.element.remove(), ScrollTrigger.scrollerProxy("#viewport", {
        scrollTop: function scrollTop(t) {
          return e.scrollTop > 79 ? $(".header__inner").addClass("header--scroll") : $(".header__inner").removeClass("header--scroll"), arguments.length && (e.scrollTop = t), e.scrollTop;
        }
      }), e.addListener(ScrollTrigger.update), ScrollTrigger.defaults({
        scroller: "#viewport"
      });
    ...
    }), $("#certificate").exists() && $("#certificate").lightGallery(), function () {
      if ($(".js-rate").exists()) {
      ...
      if ($(".js-info-slider").exists()) {
        var e = new Slider(!0, ".js-info-slider", 1, 10, 1, !0, !0, !0, "fade", !0);

        if (e.createSlider(), $(".js-graph-slider").exists()) {
          var n = new Slider(!0, ".js-graph-slider", 1, 10, 1, !0, !1, !0, "fade", !1);
          n.createSlider(), n.slider.controller.control = e.slider, e.slider.controller.control = n.slider;
        }
      }

      if ($(".js-slider-partners").exists()) {
        var r = new Slider(!1, ".js-slider-partners", 4, 82, 8, !1, !1, !1);
        r.createSlider(), window.matchMedia("(min-width: 1300px)").matches && (r.updateSlider("space", 50), console.log("1300")), window.matchMedia("(max-width: 1024px)").matches && window.matchMedia("(min-width: 501px)").matches && (r.updateSlider("space", 30), r.updateSlider("view", 3), console.log("1024")), window.matchMedia("(max-width: 500px)").matches && window.matchMedia("(min-width: 319px)").matches && (r.updateSlider("space", 20), r.updateSlider("view", 2));
      }
    ...
    }(), e = $(".cursor"), n = $(".cursor-follower"), r = 0, o = 0, i = 0, a = 0, TweenMax.to({}, .016, {
      repeat: -1,
      onRepeat: function onRepeat() {
        r += (i - r) / 9, o += (a - o) / 9, TweenMax.set(n, {
          css: {
            left: r - 12,
            top: o - 12
          }
        ...
        }), document.body.style.setProperty("--x", i + "px"), document.body.style.setProperty("--y", a + "px");
      }
      ...
      if ($(".js-ac-contacts").exists()) try {
        var t = document.querySelectorAll(".contacts__panel");
        window.matchMedia("(min-width: 620px)").matches ? (console.log(!0), t.forEach(function (t, e) {
          var n = t.nextElementSibling;
          n.style.maxHeight ? n.style.maxHeight = null : (n.style.maxHeight = n.scrollHeight + "px", console.log("accordion"));
        })) : t.forEach(function (t, e) {
          var n = t.nextElementSibling;
          n.style.maxHeight ? n.style.maxHeight = n.scrollHeight + "px" : n.style.maxHeight = null;
        });
      ...
      if ($(".accordion__panel").exists()) {
        var n = document.getElementsByClassName("accordion__panel");
